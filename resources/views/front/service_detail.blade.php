...
<section class="billboard inner-page">
  ...
  <section class="welcome_section section_wrapper detail-page-content">
    <div class="container">
              ...
              <figure class="col-img-50 thumbnail-img  w-50"><img src="{{ $service->image }}" alt=""></figure>
   ...
   <div class="clear"></div>
                    ...
                    <figure class="col-img-50 thumbnail-img w-50"><img src="{{ $service->image_1 }}" alt=""></figure>
              
           <figcaption class="detail">
            {{-- <h3 class="section_heading">Everest B.C & Gokyo Lakes</h3> --}}
            <!-- <h2>Tenzo Hotel</h2>-->
            <!--<h4>Tenzo Hotel is a place to enjoy above the clouds, dense forests, beautiful view of sunset and panoramic view of entire Kathmandu valley at the same time.</h4>-->
            <p>{!! $service->textarea_1 !!}</p>       </figcaption>
    <div class="clear"></div>
                      <figure class="col-img-50 thumbnail-img w-50"><img src="{{ $service->image_2}}" alt=""></figure>
              
         <figcaption class="detail">
            {{-- <h3 class="section_heading">Everest B.C & Gokyo Lakes</h3> --}}
            <!-- <h2>Tenzo Hotel</h2>-->
          <!--  <h4>Tenzo Hotel is a place to enjoy above the clouds, dense forests, beautiful view of sunset and panoramic view of entire Kathmandu valley at the same time.</h4>-->
          <p>{!! $service->textarea_2 !!}</p>     </figcaption>
    <div class="clear"></div>
    </div>
  </section>
